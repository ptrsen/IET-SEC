...
apt-get update -y
apt-get install -y wget curl gpg apt-transport-https ca-certificates software-properties-common debconf-utils
...
apt-get install -y python3 python3-pip pipx python3-pyqt5 python3-pyqt5.qtwebsockets python3-pyqt5.qtsvg qemu-kvm qemu-utils libvirt-clients libvirt-daemon-system virtinst dynamips software-properties-common ca-certificates curl gnupg2
